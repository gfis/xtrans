...
public abstract class ProgLangTransformer extends CharTransformer {
	...
	*/
	...
	protected HashSet/*<1.5*/<String>/*1.5>*/ words;
	...
	protected HashSet/*<1.5*/<String>/*1.5>*/ verbs;

	/** Stores the special words of the language in a hash set.
	 */
	protected void storeWords() {
		words = new HashSet/*<1.5*/<String>/*1.5>*/(keywords.length);
	...
	protected void storeVerbs() {
		verbs = new HashSet/*<1.5*/<String>/*1.5>*/(keyverbs.length);
	...
	/** stack of tokens */
	protected Stack/*<1.5*/<Token>/*1.5>*/ tokenStack;
