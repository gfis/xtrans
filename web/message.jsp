...
<%--
    ...
    @(#) $Id: message.jsp 9 2008-09-05 05:21:15Z gfis $
    2008-06-02: 006 = invalid view
    2006-10-13: Dr. Georg Fischer
	caution, must be UTF-8 encoded: 巼Ŗݟ 
--%>
<%--
...
final String [] msgText = new String [] 
    ...
    , /* 006 */ "invalid JSP page name"
    , /* 007 */ "either input file or text area must be specified"
    } ;
%>
<head>
    <title>Message</title>
