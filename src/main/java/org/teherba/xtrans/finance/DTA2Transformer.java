/*  Transformer for DTA (German payments exchange file)
    @(#) $Id: DTA2Transformer.java 566 2010-10-19 16:32:04Z gfis $
...
import  org.teherba.xtrans.finance.DTA2RecordBase;
 ...
 */
public class DTA2Transformer extends ByteTransformer {
    public final static String CVSID = "@(#) $Id: DTA2Transformer.java 566 2010-10-19 16:32:04Z gfis $";

    /** log4j logger (category) */
    private Logger log;

    /** record for the specific format */
    private DTA2RecordBase genRecord;

    /** No-args Constructor
     */
    public DTA2Transformer() {
        super();
        setFormatCodes("dta2");
    ...
    /** record for the specific format */
    private DTA2RecordBase serRecord;

    /** Receive notification of the beginning of the document.
     */
    public void startDocument() {
        serRecord = new DTA2RecordBase();
        sumCount   = 0L;
        sumAccount = 0L;
        sumBLZ     = 0L;
        sumAmount  = 0L;
